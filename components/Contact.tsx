  ...
  const sendEmail = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await emailjs.sendForm(
        "service_5t36c41",   // 🔴 replace from EmailJS
        "template_it2omce",  // 🔴 replace from EmailJS
        e.currentTarget,
        "eH9wRWO7tr6WznFTh"    // 🔴 replace from EmailJS
      );
      ...
      >
        ...
        <p className="mt-3 flex justify-center items-center gap-3 text-gray-400">
          ...
          <span className="text-white">
            linkedin.com/in/jishnu-ray-707869265
          </span>
        </p>
        ...
        <p className="mt-3 flex justify-center items-center gap-3 text-gray-400">
          ...
          <span className="text-white">
            researchgate.net/profile/Jishnu-Ray-3
          </span>
        </p>
        ...
        >
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-8 py-3 rounded-full bg-cyan-500/90 text-white text-sm font-medium hover:bg-cyan-400 transition disabled:opacity-60"
            >
